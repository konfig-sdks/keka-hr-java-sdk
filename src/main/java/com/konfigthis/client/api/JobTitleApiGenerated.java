...
import com.konfigthis.client.model.JobTitlePagedResponse;
...
public class JobTitleApiGenerated {
    ...
    private okhttp3.Call getAllCall(OffsetDateTime lastModified, Integer pageNumber, Integer pageSize, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/hris/jobtitles";
    ...
    private ApiResponse<JobTitlePagedResponse> getAllWithHttpInfo(OffsetDateTime lastModified, Integer pageNumber, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = getAllValidateBeforeCall(lastModified, pageNumber, pageSize, null);
        Type localVarReturnType = new TypeToken<JobTitlePagedResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAllAsync(OffsetDateTime lastModified, Integer pageNumber, Integer pageSize, final ApiCallback<JobTitlePagedResponse> _callback) throws ApiException {
    ...
    public class GetAllRequestBuilder {
         ...
         */
        public JobTitlePagedResponse execute() throws ApiException {
            ApiResponse<JobTitlePagedResponse> localVarResp = getAllWithHttpInfo(lastModified, pageNumber, pageSize);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getAll request with HTTP info returned
         * @return ApiResponse&lt;JobTitlePagedResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<JobTitlePagedResponse> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<JobTitlePagedResponse> _callback) throws ApiException {
