...
public class GroupTypePagedResponse {
  ...
  private List<GroupType> data = null;
  ...
  public GroupTypePagedResponse() {
  }

  public GroupTypePagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public GroupTypePagedResponse message(String message) {
  ...
  **/
  ...
  public GroupTypePagedResponse errors(List<String> errors) {
  ...
  public GroupTypePagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public GroupTypePagedResponse data(List<GroupType> data) {
  ...
  public GroupTypePagedResponse addDataItem(GroupType dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public GroupTypePagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public GroupTypePagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public GroupTypePagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public GroupTypePagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public GroupTypePagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public GroupTypePagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public GroupTypePagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public GroupTypePagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the GroupTypePagedResponse instance itself
   */
  public GroupTypePagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GroupTypePagedResponse groupTypePagedResponse = (GroupTypePagedResponse) o;
    return Objects.equals(this.succeeded, groupTypePagedResponse.succeeded) &&
        Objects.equals(this.message, groupTypePagedResponse.message) &&
        Objects.equals(this.errors, groupTypePagedResponse.errors) &&
        Objects.equals(this.data, groupTypePagedResponse.data) &&
        Objects.equals(this.pageNumber, groupTypePagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, groupTypePagedResponse.pageSize) &&
        Objects.equals(this.firstPage, groupTypePagedResponse.firstPage) &&
        Objects.equals(this.lastPage, groupTypePagedResponse.lastPage) &&
        Objects.equals(this.totalPages, groupTypePagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, groupTypePagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, groupTypePagedResponse.nextPage) &&
        Objects.equals(this.previousPage, groupTypePagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, groupTypePagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupTypePagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroupTypePagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroupTypePagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupTypePagedResponse is not found in the empty JSON string", GroupTypePagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            GroupType.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupTypePagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupTypePagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupTypePagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupTypePagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupTypePagedResponse>() {
           @Override
           public void write(JsonWriter out, GroupTypePagedResponse value) throws IOException {
           ...
           @Override
           public GroupTypePagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GroupTypePagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GroupTypePagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GroupTypePagedResponse
  * @throws IOException if the JSON string is invalid with respect to GroupTypePagedResponse
  */
  public static GroupTypePagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupTypePagedResponse.class);
  }

 /**
  * Convert an instance of GroupTypePagedResponse to an JSON string
  *
  * @return JSON string
  */
