...
import com.konfigthis.client.model.APIPraise;
...
public class APIPraisePagedResponse {
  ...
  private List<APIPraise> data = null;
  ...
  public APIPraisePagedResponse() {
  }

  public APIPraisePagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public APIPraisePagedResponse message(String message) {
  ...
  **/
  ...
  public APIPraisePagedResponse errors(List<String> errors) {
  ...
  public APIPraisePagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public APIPraisePagedResponse data(List<APIPraise> data) {
  ...
  public APIPraisePagedResponse addDataItem(APIPraise dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<APIPraise> getData() {
    return data;
  }


  public void setData(List<APIPraise> data) {
  ...
  public APIPraisePagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public APIPraisePagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public APIPraisePagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public APIPraisePagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public APIPraisePagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public APIPraisePagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public APIPraisePagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public APIPraisePagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the APIPraisePagedResponse instance itself
   */
  public APIPraisePagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    APIPraisePagedResponse apIPraisePagedResponse = (APIPraisePagedResponse) o;
    return Objects.equals(this.succeeded, apIPraisePagedResponse.succeeded) &&
        Objects.equals(this.message, apIPraisePagedResponse.message) &&
        Objects.equals(this.errors, apIPraisePagedResponse.errors) &&
        Objects.equals(this.data, apIPraisePagedResponse.data) &&
        Objects.equals(this.pageNumber, apIPraisePagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, apIPraisePagedResponse.pageSize) &&
        Objects.equals(this.firstPage, apIPraisePagedResponse.firstPage) &&
        Objects.equals(this.lastPage, apIPraisePagedResponse.lastPage) &&
        Objects.equals(this.totalPages, apIPraisePagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, apIPraisePagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, apIPraisePagedResponse.nextPage) &&
        Objects.equals(this.previousPage, apIPraisePagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, apIPraisePagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class APIPraisePagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to APIPraisePagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!APIPraisePagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in APIPraisePagedResponse is not found in the empty JSON string", APIPraisePagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            APIPraise.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!APIPraisePagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'APIPraisePagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<APIPraisePagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(APIPraisePagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<APIPraisePagedResponse>() {
           @Override
           public void write(JsonWriter out, APIPraisePagedResponse value) throws IOException {
           ...
           @Override
           public APIPraisePagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             APIPraisePagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of APIPraisePagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of APIPraisePagedResponse
  * @throws IOException if the JSON string is invalid with respect to APIPraisePagedResponse
  */
  public static APIPraisePagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, APIPraisePagedResponse.class);
  }

 /**
  * Convert an instance of APIPraisePagedResponse to an JSON string
  *
  * @return JSON string
  */
