...
public class GroupPagedResponse {
  ...
  public GroupPagedResponse() {
  }

  public GroupPagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public GroupPagedResponse message(String message) {
  ...
  **/
  ...
  public GroupPagedResponse errors(List<String> errors) {
  ...
  public GroupPagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public GroupPagedResponse data(List<Group> data) {
  ...
  public GroupPagedResponse addDataItem(Group dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public GroupPagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public GroupPagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public GroupPagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public GroupPagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public GroupPagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public GroupPagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public GroupPagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public GroupPagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the GroupPagedResponse instance itself
   */
  public GroupPagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GroupPagedResponse groupPagedResponse = (GroupPagedResponse) o;
    return Objects.equals(this.succeeded, groupPagedResponse.succeeded) &&
        Objects.equals(this.message, groupPagedResponse.message) &&
        Objects.equals(this.errors, groupPagedResponse.errors) &&
        Objects.equals(this.data, groupPagedResponse.data) &&
        Objects.equals(this.pageNumber, groupPagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, groupPagedResponse.pageSize) &&
        Objects.equals(this.firstPage, groupPagedResponse.firstPage) &&
        Objects.equals(this.lastPage, groupPagedResponse.lastPage) &&
        Objects.equals(this.totalPages, groupPagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, groupPagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, groupPagedResponse.nextPage) &&
        Objects.equals(this.previousPage, groupPagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, groupPagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupPagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroupPagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroupPagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupPagedResponse is not found in the empty JSON string", GroupPagedResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupPagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupPagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupPagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupPagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupPagedResponse>() {
           @Override
           public void write(JsonWriter out, GroupPagedResponse value) throws IOException {
           ...
           @Override
           public GroupPagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GroupPagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GroupPagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GroupPagedResponse
  * @throws IOException if the JSON string is invalid with respect to GroupPagedResponse
  */
  public static GroupPagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupPagedResponse.class);
  }

 /**
  * Convert an instance of GroupPagedResponse to an JSON string
  *
  * @return JSON string
  */
