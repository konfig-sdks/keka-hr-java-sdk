...
import com.konfigthis.client.model.APIGoal;
...
public class APIGoalPagedResponse {
  ...
  private List<APIGoal> data = null;
  ...
  public APIGoalPagedResponse() {
  }

  public APIGoalPagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public APIGoalPagedResponse message(String message) {
  ...
  **/
  ...
  public APIGoalPagedResponse errors(List<String> errors) {
  ...
  public APIGoalPagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public APIGoalPagedResponse data(List<APIGoal> data) {
  ...
  public APIGoalPagedResponse addDataItem(APIGoal dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<APIGoal> getData() {
    return data;
  }


  public void setData(List<APIGoal> data) {
  ...
  public APIGoalPagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public APIGoalPagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public APIGoalPagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public APIGoalPagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public APIGoalPagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public APIGoalPagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public APIGoalPagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public APIGoalPagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the APIGoalPagedResponse instance itself
   */
  public APIGoalPagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    APIGoalPagedResponse apIGoalPagedResponse = (APIGoalPagedResponse) o;
    return Objects.equals(this.succeeded, apIGoalPagedResponse.succeeded) &&
        Objects.equals(this.message, apIGoalPagedResponse.message) &&
        Objects.equals(this.errors, apIGoalPagedResponse.errors) &&
        Objects.equals(this.data, apIGoalPagedResponse.data) &&
        Objects.equals(this.pageNumber, apIGoalPagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, apIGoalPagedResponse.pageSize) &&
        Objects.equals(this.firstPage, apIGoalPagedResponse.firstPage) &&
        Objects.equals(this.lastPage, apIGoalPagedResponse.lastPage) &&
        Objects.equals(this.totalPages, apIGoalPagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, apIGoalPagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, apIGoalPagedResponse.nextPage) &&
        Objects.equals(this.previousPage, apIGoalPagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, apIGoalPagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class APIGoalPagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to APIGoalPagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!APIGoalPagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in APIGoalPagedResponse is not found in the empty JSON string", APIGoalPagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            APIGoal.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!APIGoalPagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'APIGoalPagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<APIGoalPagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(APIGoalPagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<APIGoalPagedResponse>() {
           @Override
           public void write(JsonWriter out, APIGoalPagedResponse value) throws IOException {
           ...
           @Override
           public APIGoalPagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             APIGoalPagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of APIGoalPagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of APIGoalPagedResponse
  * @throws IOException if the JSON string is invalid with respect to APIGoalPagedResponse
  */
  public static APIGoalPagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, APIGoalPagedResponse.class);
  }

 /**
  * Convert an instance of APIGoalPagedResponse to an JSON string
  *
  * @return JSON string
  */
