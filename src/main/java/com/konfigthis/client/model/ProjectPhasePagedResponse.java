...
import com.konfigthis.client.model.ProjectPhase;
...
public class ProjectPhasePagedResponse {
  ...
  private List<ProjectPhase> data = null;
  ...
  public ProjectPhasePagedResponse() {
  }

  public ProjectPhasePagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public ProjectPhasePagedResponse message(String message) {
  ...
  **/
  ...
  public ProjectPhasePagedResponse errors(List<String> errors) {
  ...
  public ProjectPhasePagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public ProjectPhasePagedResponse data(List<ProjectPhase> data) {
  ...
  public ProjectPhasePagedResponse addDataItem(ProjectPhase dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<ProjectPhase> getData() {
    return data;
  }


  public void setData(List<ProjectPhase> data) {
  ...
  public ProjectPhasePagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public ProjectPhasePagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public ProjectPhasePagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public ProjectPhasePagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public ProjectPhasePagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public ProjectPhasePagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public ProjectPhasePagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public ProjectPhasePagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the ProjectPhasePagedResponse instance itself
   */
  public ProjectPhasePagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectPhasePagedResponse projectPhasePagedResponse = (ProjectPhasePagedResponse) o;
    return Objects.equals(this.succeeded, projectPhasePagedResponse.succeeded) &&
        Objects.equals(this.message, projectPhasePagedResponse.message) &&
        Objects.equals(this.errors, projectPhasePagedResponse.errors) &&
        Objects.equals(this.data, projectPhasePagedResponse.data) &&
        Objects.equals(this.pageNumber, projectPhasePagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, projectPhasePagedResponse.pageSize) &&
        Objects.equals(this.firstPage, projectPhasePagedResponse.firstPage) &&
        Objects.equals(this.lastPage, projectPhasePagedResponse.lastPage) &&
        Objects.equals(this.totalPages, projectPhasePagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, projectPhasePagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, projectPhasePagedResponse.nextPage) &&
        Objects.equals(this.previousPage, projectPhasePagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, projectPhasePagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectPhasePagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProjectPhasePagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectPhasePagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectPhasePagedResponse is not found in the empty JSON string", ProjectPhasePagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ProjectPhase.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectPhasePagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectPhasePagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectPhasePagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectPhasePagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectPhasePagedResponse>() {
           @Override
           public void write(JsonWriter out, ProjectPhasePagedResponse value) throws IOException {
           ...
           @Override
           public ProjectPhasePagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProjectPhasePagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProjectPhasePagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProjectPhasePagedResponse
  * @throws IOException if the JSON string is invalid with respect to ProjectPhasePagedResponse
  */
  public static ProjectPhasePagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectPhasePagedResponse.class);
  }

 /**
  * Convert an instance of ProjectPhasePagedResponse to an JSON string
  *
  * @return JSON string
  */
