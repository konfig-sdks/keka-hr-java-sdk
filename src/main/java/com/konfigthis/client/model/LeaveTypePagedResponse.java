...
public class LeaveTypePagedResponse {
  ...
  private List<LeaveType> data = null;
  ...
  public LeaveTypePagedResponse() {
  }

  public LeaveTypePagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public LeaveTypePagedResponse message(String message) {
  ...
  **/
  ...
  public LeaveTypePagedResponse errors(List<String> errors) {
  ...
  public LeaveTypePagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public LeaveTypePagedResponse data(List<LeaveType> data) {
  ...
  public LeaveTypePagedResponse addDataItem(LeaveType dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public LeaveTypePagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public LeaveTypePagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public LeaveTypePagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public LeaveTypePagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public LeaveTypePagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public LeaveTypePagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public LeaveTypePagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public LeaveTypePagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the LeaveTypePagedResponse instance itself
   */
  public LeaveTypePagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveTypePagedResponse leaveTypePagedResponse = (LeaveTypePagedResponse) o;
    return Objects.equals(this.succeeded, leaveTypePagedResponse.succeeded) &&
        Objects.equals(this.message, leaveTypePagedResponse.message) &&
        Objects.equals(this.errors, leaveTypePagedResponse.errors) &&
        Objects.equals(this.data, leaveTypePagedResponse.data) &&
        Objects.equals(this.pageNumber, leaveTypePagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, leaveTypePagedResponse.pageSize) &&
        Objects.equals(this.firstPage, leaveTypePagedResponse.firstPage) &&
        Objects.equals(this.lastPage, leaveTypePagedResponse.lastPage) &&
        Objects.equals(this.totalPages, leaveTypePagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, leaveTypePagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, leaveTypePagedResponse.nextPage) &&
        Objects.equals(this.previousPage, leaveTypePagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, leaveTypePagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeaveTypePagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveTypePagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveTypePagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveTypePagedResponse is not found in the empty JSON string", LeaveTypePagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            LeaveType.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveTypePagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveTypePagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveTypePagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveTypePagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveTypePagedResponse>() {
           @Override
           public void write(JsonWriter out, LeaveTypePagedResponse value) throws IOException {
           ...
           @Override
           public LeaveTypePagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveTypePagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveTypePagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveTypePagedResponse
  * @throws IOException if the JSON string is invalid with respect to LeaveTypePagedResponse
  */
  public static LeaveTypePagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveTypePagedResponse.class);
  }

 /**
  * Convert an instance of LeaveTypePagedResponse to an JSON string
  *
  * @return JSON string
  */
