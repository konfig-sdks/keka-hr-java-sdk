...
public class ApiLookupPagedResponse {
  ...
  private List<ApiLookup> data = null;
  ...
  public ApiLookupPagedResponse() {
  }

  public ApiLookupPagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public ApiLookupPagedResponse message(String message) {
  ...
  **/
  ...
  public ApiLookupPagedResponse errors(List<String> errors) {
  ...
  public ApiLookupPagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public ApiLookupPagedResponse data(List<ApiLookup> data) {
  ...
  public ApiLookupPagedResponse addDataItem(ApiLookup dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<ApiLookup> getData() {
    return data;
  }


  public void setData(List<ApiLookup> data) {
  ...
  public ApiLookupPagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public ApiLookupPagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public ApiLookupPagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public ApiLookupPagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public ApiLookupPagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public ApiLookupPagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public ApiLookupPagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public ApiLookupPagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the ApiLookupPagedResponse instance itself
   */
  public ApiLookupPagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApiLookupPagedResponse apiLookupPagedResponse = (ApiLookupPagedResponse) o;
    return Objects.equals(this.succeeded, apiLookupPagedResponse.succeeded) &&
        Objects.equals(this.message, apiLookupPagedResponse.message) &&
        Objects.equals(this.errors, apiLookupPagedResponse.errors) &&
        Objects.equals(this.data, apiLookupPagedResponse.data) &&
        Objects.equals(this.pageNumber, apiLookupPagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, apiLookupPagedResponse.pageSize) &&
        Objects.equals(this.firstPage, apiLookupPagedResponse.firstPage) &&
        Objects.equals(this.lastPage, apiLookupPagedResponse.lastPage) &&
        Objects.equals(this.totalPages, apiLookupPagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, apiLookupPagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, apiLookupPagedResponse.nextPage) &&
        Objects.equals(this.previousPage, apiLookupPagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, apiLookupPagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiLookupPagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApiLookupPagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApiLookupPagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiLookupPagedResponse is not found in the empty JSON string", ApiLookupPagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ApiLookup.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiLookupPagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiLookupPagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiLookupPagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiLookupPagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiLookupPagedResponse>() {
           @Override
           public void write(JsonWriter out, ApiLookupPagedResponse value) throws IOException {
           ...
           @Override
           public ApiLookupPagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ApiLookupPagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ApiLookupPagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiLookupPagedResponse
  * @throws IOException if the JSON string is invalid with respect to ApiLookupPagedResponse
  */
  public static ApiLookupPagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiLookupPagedResponse.class);
  }

 /**
  * Convert an instance of ApiLookupPagedResponse to an JSON string
  *
  * @return JSON string
  */
