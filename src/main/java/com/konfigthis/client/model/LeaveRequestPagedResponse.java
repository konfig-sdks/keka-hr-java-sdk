...
public class LeaveRequestPagedResponse {
  ...
  private List<LeaveRequest> data = null;
  ...
  public LeaveRequestPagedResponse() {
  }

  public LeaveRequestPagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public LeaveRequestPagedResponse message(String message) {
  ...
  **/
  ...
  public LeaveRequestPagedResponse errors(List<String> errors) {
  ...
  public LeaveRequestPagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public LeaveRequestPagedResponse data(List<LeaveRequest> data) {
  ...
  public LeaveRequestPagedResponse addDataItem(LeaveRequest dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public void setData(List<LeaveRequest> data) {
  ...
  public LeaveRequestPagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public LeaveRequestPagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public LeaveRequestPagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public LeaveRequestPagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public LeaveRequestPagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public LeaveRequestPagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public LeaveRequestPagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public LeaveRequestPagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the LeaveRequestPagedResponse instance itself
   */
  public LeaveRequestPagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveRequestPagedResponse leaveRequestPagedResponse = (LeaveRequestPagedResponse) o;
    return Objects.equals(this.succeeded, leaveRequestPagedResponse.succeeded) &&
        Objects.equals(this.message, leaveRequestPagedResponse.message) &&
        Objects.equals(this.errors, leaveRequestPagedResponse.errors) &&
        Objects.equals(this.data, leaveRequestPagedResponse.data) &&
        Objects.equals(this.pageNumber, leaveRequestPagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, leaveRequestPagedResponse.pageSize) &&
        Objects.equals(this.firstPage, leaveRequestPagedResponse.firstPage) &&
        Objects.equals(this.lastPage, leaveRequestPagedResponse.lastPage) &&
        Objects.equals(this.totalPages, leaveRequestPagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, leaveRequestPagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, leaveRequestPagedResponse.nextPage) &&
        Objects.equals(this.previousPage, leaveRequestPagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, leaveRequestPagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeaveRequestPagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveRequestPagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveRequestPagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveRequestPagedResponse is not found in the empty JSON string", LeaveRequestPagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            LeaveRequest.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveRequestPagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveRequestPagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveRequestPagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveRequestPagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveRequestPagedResponse>() {
           @Override
           public void write(JsonWriter out, LeaveRequestPagedResponse value) throws IOException {
           ...
           @Override
           public LeaveRequestPagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveRequestPagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveRequestPagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveRequestPagedResponse
  * @throws IOException if the JSON string is invalid with respect to LeaveRequestPagedResponse
  */
  public static LeaveRequestPagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveRequestPagedResponse.class);
  }

 /**
  * Convert an instance of LeaveRequestPagedResponse to an JSON string
  *
  * @return JSON string
  */
