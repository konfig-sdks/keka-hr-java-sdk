...
import com.konfigthis.client.model.APIBadge;
...
public class APIBadgePagedResponse {
  ...
  private List<APIBadge> data = null;
  ...
  public APIBadgePagedResponse() {
  }

  public APIBadgePagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public APIBadgePagedResponse message(String message) {
  ...
  **/
  ...
  public APIBadgePagedResponse errors(List<String> errors) {
  ...
  public APIBadgePagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public APIBadgePagedResponse data(List<APIBadge> data) {
  ...
  public APIBadgePagedResponse addDataItem(APIBadge dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<APIBadge> getData() {
    return data;
  }


  public void setData(List<APIBadge> data) {
  ...
  public APIBadgePagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public APIBadgePagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public APIBadgePagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public APIBadgePagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public APIBadgePagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public APIBadgePagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public APIBadgePagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public APIBadgePagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the APIBadgePagedResponse instance itself
   */
  public APIBadgePagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    APIBadgePagedResponse apIBadgePagedResponse = (APIBadgePagedResponse) o;
    return Objects.equals(this.succeeded, apIBadgePagedResponse.succeeded) &&
        Objects.equals(this.message, apIBadgePagedResponse.message) &&
        Objects.equals(this.errors, apIBadgePagedResponse.errors) &&
        Objects.equals(this.data, apIBadgePagedResponse.data) &&
        Objects.equals(this.pageNumber, apIBadgePagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, apIBadgePagedResponse.pageSize) &&
        Objects.equals(this.firstPage, apIBadgePagedResponse.firstPage) &&
        Objects.equals(this.lastPage, apIBadgePagedResponse.lastPage) &&
        Objects.equals(this.totalPages, apIBadgePagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, apIBadgePagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, apIBadgePagedResponse.nextPage) &&
        Objects.equals(this.previousPage, apIBadgePagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, apIBadgePagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class APIBadgePagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to APIBadgePagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!APIBadgePagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in APIBadgePagedResponse is not found in the empty JSON string", APIBadgePagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            APIBadge.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!APIBadgePagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'APIBadgePagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<APIBadgePagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(APIBadgePagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<APIBadgePagedResponse>() {
           @Override
           public void write(JsonWriter out, APIBadgePagedResponse value) throws IOException {
           ...
           @Override
           public APIBadgePagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             APIBadgePagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of APIBadgePagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of APIBadgePagedResponse
  * @throws IOException if the JSON string is invalid with respect to APIBadgePagedResponse
  */
  public static APIBadgePagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, APIBadgePagedResponse.class);
  }

 /**
  * Convert an instance of APIBadgePagedResponse to an JSON string
  *
  * @return JSON string
  */
