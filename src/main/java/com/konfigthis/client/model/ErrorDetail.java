 ...
 */
@ApiModel(description = "Represents a detailed error message for an individual field.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ErrorDetail {
  ...
  **/
  ...
  @ApiModelProperty(value = "Gets or sets the name of the field that caused the error.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Gets or sets the error message associated with the field.")
