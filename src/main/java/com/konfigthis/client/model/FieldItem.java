...
import com.konfigthis.client.model.FieldChoice;
...
public class FieldItem {
  ...
  private List<FieldChoice> fieldOptions = null;
  ...
  **/
  ...
  public FieldItem fieldName(String fieldName) {
  ...
  **/
  ...
  public FieldItem fieldType(FieldType fieldType) {
  ...
  **/
  ...
  public FieldItem isSystemDefined(Boolean isSystemDefined) {
  ...
  **/
  ...
  public FieldItem fieldOptions(List<FieldChoice> fieldOptions) {
  ...
  public FieldItem addFieldOptionsItem(FieldChoice fieldOptionsItem) {
  ...
  **/
  ...
  public List<FieldChoice> getFieldOptions() {
    return fieldOptions;
  }


  public void setFieldOptions(List<FieldChoice> fieldOptions) {
   ...
   * @return the FieldItem instance itself
   */
  public FieldItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, fieldItem.id) &&
        Objects.equals(this.fieldName, fieldItem.fieldName) &&
        Objects.equals(this.required, fieldItem.required) &&
        Objects.equals(this.fieldType, fieldItem.fieldType) &&
        Objects.equals(this.isSystemDefined, fieldItem.isSystemDefined) &&
        Objects.equals(this.fieldOptions, fieldItem.fieldOptions)&&
        Objects.equals(this.additionalProperties, fieldItem.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, fieldName, required, fieldType, isSystemDefined, fieldOptions, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FieldItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("fieldOptions") != null && !jsonObj.get("fieldOptions").isJsonNull()) {
        ...
        if (jsonArrayfieldOptions != null) {
          ...
          for (int i = 0; i < jsonArrayfieldOptions.size(); i++) {
            FieldChoice.validateJsonObject(jsonArrayfieldOptions.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FieldItem>() {
           ...
           public FieldItem read(JsonReader in) throws IOException {
             ...
             FieldItem instance = thisAdapter.fromJsonTree(jsonObj);
