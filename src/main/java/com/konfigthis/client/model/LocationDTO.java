...
public class LocationDTO {
  ...
  **/
   ...
   * @return the LocationDTO instance itself
   */
  public LocationDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, locationDTO.name) &&
        ...
        Objects.equals(this.countryName, locationDTO.countryName)&&
        Objects.equals(this.additionalProperties, locationDTO.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, city, state, countryName, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LocationDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LocationDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LocationDTO>() {
           ...
           public LocationDTO read(JsonReader in) throws IOException {
             ...
             LocationDTO instance = thisAdapter.fromJsonTree(jsonObj);
