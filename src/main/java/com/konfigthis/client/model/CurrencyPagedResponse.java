...
public class CurrencyPagedResponse {
  ...
  public CurrencyPagedResponse() {
  }

  public CurrencyPagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public CurrencyPagedResponse message(String message) {
  ...
  **/
  ...
  public CurrencyPagedResponse errors(List<String> errors) {
  ...
  public CurrencyPagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public CurrencyPagedResponse data(List<Currency> data) {
  ...
  public CurrencyPagedResponse addDataItem(Currency dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public CurrencyPagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public CurrencyPagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public CurrencyPagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public CurrencyPagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public CurrencyPagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public CurrencyPagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public CurrencyPagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public CurrencyPagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the CurrencyPagedResponse instance itself
   */
  public CurrencyPagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CurrencyPagedResponse currencyPagedResponse = (CurrencyPagedResponse) o;
    return Objects.equals(this.succeeded, currencyPagedResponse.succeeded) &&
        Objects.equals(this.message, currencyPagedResponse.message) &&
        Objects.equals(this.errors, currencyPagedResponse.errors) &&
        Objects.equals(this.data, currencyPagedResponse.data) &&
        Objects.equals(this.pageNumber, currencyPagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, currencyPagedResponse.pageSize) &&
        Objects.equals(this.firstPage, currencyPagedResponse.firstPage) &&
        Objects.equals(this.lastPage, currencyPagedResponse.lastPage) &&
        Objects.equals(this.totalPages, currencyPagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, currencyPagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, currencyPagedResponse.nextPage) &&
        Objects.equals(this.previousPage, currencyPagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, currencyPagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrencyPagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CurrencyPagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CurrencyPagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrencyPagedResponse is not found in the empty JSON string", CurrencyPagedResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrencyPagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrencyPagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrencyPagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrencyPagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrencyPagedResponse>() {
           @Override
           public void write(JsonWriter out, CurrencyPagedResponse value) throws IOException {
           ...
           @Override
           public CurrencyPagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CurrencyPagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CurrencyPagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CurrencyPagedResponse
  * @throws IOException if the JSON string is invalid with respect to CurrencyPagedResponse
  */
  public static CurrencyPagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrencyPagedResponse.class);
  }

 /**
  * Convert an instance of CurrencyPagedResponse to an JSON string
  *
  * @return JSON string
  */
