...
public class JobTitlePagedResponse {
  ...
  private List<JobTitle> data = null;
  ...
  public JobTitlePagedResponse() {
  }

  public JobTitlePagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public JobTitlePagedResponse message(String message) {
  ...
  **/
  ...
  public JobTitlePagedResponse errors(List<String> errors) {
  ...
  public JobTitlePagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public JobTitlePagedResponse data(List<JobTitle> data) {
  ...
  public JobTitlePagedResponse addDataItem(JobTitle dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public JobTitlePagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public JobTitlePagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public JobTitlePagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public JobTitlePagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public JobTitlePagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public JobTitlePagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public JobTitlePagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public JobTitlePagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the JobTitlePagedResponse instance itself
   */
  public JobTitlePagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JobTitlePagedResponse jobTitlePagedResponse = (JobTitlePagedResponse) o;
    return Objects.equals(this.succeeded, jobTitlePagedResponse.succeeded) &&
        Objects.equals(this.message, jobTitlePagedResponse.message) &&
        Objects.equals(this.errors, jobTitlePagedResponse.errors) &&
        Objects.equals(this.data, jobTitlePagedResponse.data) &&
        Objects.equals(this.pageNumber, jobTitlePagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, jobTitlePagedResponse.pageSize) &&
        Objects.equals(this.firstPage, jobTitlePagedResponse.firstPage) &&
        Objects.equals(this.lastPage, jobTitlePagedResponse.lastPage) &&
        Objects.equals(this.totalPages, jobTitlePagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, jobTitlePagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, jobTitlePagedResponse.nextPage) &&
        Objects.equals(this.previousPage, jobTitlePagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, jobTitlePagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobTitlePagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to JobTitlePagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JobTitlePagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobTitlePagedResponse is not found in the empty JSON string", JobTitlePagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            JobTitle.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobTitlePagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobTitlePagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobTitlePagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobTitlePagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<JobTitlePagedResponse>() {
           @Override
           public void write(JsonWriter out, JobTitlePagedResponse value) throws IOException {
           ...
           @Override
           public JobTitlePagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JobTitlePagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JobTitlePagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JobTitlePagedResponse
  * @throws IOException if the JSON string is invalid with respect to JobTitlePagedResponse
  */
  public static JobTitlePagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobTitlePagedResponse.class);
  }

 /**
  * Convert an instance of JobTitlePagedResponse to an JSON string
  *
  * @return JSON string
  */
