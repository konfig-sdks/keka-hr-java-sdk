...
public class AssetPagedResponse {
  ...
  public AssetPagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public AssetPagedResponse message(String message) {
  ...
  **/
  ...
  public AssetPagedResponse errors(List<String> errors) {
  ...
  public AssetPagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public AssetPagedResponse data(List<Asset> data) {
  ...
  public AssetPagedResponse addDataItem(Asset dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public AssetPagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public AssetPagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public AssetPagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public AssetPagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public AssetPagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public AssetPagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public AssetPagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public AssetPagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the AssetPagedResponse instance itself
   */
  public AssetPagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AssetPagedResponse assetPagedResponse = (AssetPagedResponse) o;
    return Objects.equals(this.succeeded, assetPagedResponse.succeeded) &&
        Objects.equals(this.message, assetPagedResponse.message) &&
        Objects.equals(this.errors, assetPagedResponse.errors) &&
        Objects.equals(this.data, assetPagedResponse.data) &&
        Objects.equals(this.pageNumber, assetPagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, assetPagedResponse.pageSize) &&
        Objects.equals(this.firstPage, assetPagedResponse.firstPage) &&
        Objects.equals(this.lastPage, assetPagedResponse.lastPage) &&
        Objects.equals(this.totalPages, assetPagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, assetPagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, assetPagedResponse.nextPage) &&
        Objects.equals(this.previousPage, assetPagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, assetPagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssetPagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AssetPagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AssetPagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssetPagedResponse is not found in the empty JSON string", AssetPagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Asset.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssetPagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssetPagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssetPagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssetPagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AssetPagedResponse>() {
           @Override
           public void write(JsonWriter out, AssetPagedResponse value) throws IOException {
           ...
           @Override
           public AssetPagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AssetPagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AssetPagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AssetPagedResponse
  * @throws IOException if the JSON string is invalid with respect to AssetPagedResponse
  */
  public static AssetPagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssetPagedResponse.class);
  }

 /**
  * Convert an instance of AssetPagedResponse to an JSON string
  *
  * @return JSON string
  */
