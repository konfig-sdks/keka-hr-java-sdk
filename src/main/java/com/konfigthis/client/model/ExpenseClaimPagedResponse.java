...
import com.konfigthis.client.model.ExpenseClaim;
...
public class ExpenseClaimPagedResponse {
  ...
  private List<ExpenseClaim> data = null;
  ...
  public ExpenseClaimPagedResponse() {
  }

  public ExpenseClaimPagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public ExpenseClaimPagedResponse message(String message) {
  ...
  **/
  ...
  public ExpenseClaimPagedResponse errors(List<String> errors) {
  ...
  public ExpenseClaimPagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public ExpenseClaimPagedResponse data(List<ExpenseClaim> data) {
  ...
  public ExpenseClaimPagedResponse addDataItem(ExpenseClaim dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<ExpenseClaim> getData() {
    return data;
  }


  public void setData(List<ExpenseClaim> data) {
  ...
  public ExpenseClaimPagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public ExpenseClaimPagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public ExpenseClaimPagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public ExpenseClaimPagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public ExpenseClaimPagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public ExpenseClaimPagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public ExpenseClaimPagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public ExpenseClaimPagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the ExpenseClaimPagedResponse instance itself
   */
  public ExpenseClaimPagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpenseClaimPagedResponse expenseClaimPagedResponse = (ExpenseClaimPagedResponse) o;
    return Objects.equals(this.succeeded, expenseClaimPagedResponse.succeeded) &&
        Objects.equals(this.message, expenseClaimPagedResponse.message) &&
        Objects.equals(this.errors, expenseClaimPagedResponse.errors) &&
        Objects.equals(this.data, expenseClaimPagedResponse.data) &&
        Objects.equals(this.pageNumber, expenseClaimPagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, expenseClaimPagedResponse.pageSize) &&
        Objects.equals(this.firstPage, expenseClaimPagedResponse.firstPage) &&
        Objects.equals(this.lastPage, expenseClaimPagedResponse.lastPage) &&
        Objects.equals(this.totalPages, expenseClaimPagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, expenseClaimPagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, expenseClaimPagedResponse.nextPage) &&
        Objects.equals(this.previousPage, expenseClaimPagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, expenseClaimPagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExpenseClaimPagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ExpenseClaimPagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExpenseClaimPagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExpenseClaimPagedResponse is not found in the empty JSON string", ExpenseClaimPagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ExpenseClaim.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpenseClaimPagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpenseClaimPagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpenseClaimPagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpenseClaimPagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpenseClaimPagedResponse>() {
           @Override
           public void write(JsonWriter out, ExpenseClaimPagedResponse value) throws IOException {
           ...
           @Override
           public ExpenseClaimPagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ExpenseClaimPagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ExpenseClaimPagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ExpenseClaimPagedResponse
  * @throws IOException if the JSON string is invalid with respect to ExpenseClaimPagedResponse
  */
  public static ExpenseClaimPagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExpenseClaimPagedResponse.class);
  }

 /**
  * Convert an instance of ExpenseClaimPagedResponse to an JSON string
  *
  * @return JSON string
  */
