...
import com.konfigthis.client.model.APIProject;
...
public class APIProjectPagedResponse {
  ...
  private List<APIProject> data = null;
  ...
  public APIProjectPagedResponse() {
  }

  public APIProjectPagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public APIProjectPagedResponse message(String message) {
  ...
  **/
  ...
  public APIProjectPagedResponse errors(List<String> errors) {
  ...
  public APIProjectPagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public APIProjectPagedResponse data(List<APIProject> data) {
  ...
  public APIProjectPagedResponse addDataItem(APIProject dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<APIProject> getData() {
    return data;
  }


  public void setData(List<APIProject> data) {
  ...
  public APIProjectPagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public APIProjectPagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public APIProjectPagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public APIProjectPagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public APIProjectPagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public APIProjectPagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public APIProjectPagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public APIProjectPagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the APIProjectPagedResponse instance itself
   */
  public APIProjectPagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    APIProjectPagedResponse apIProjectPagedResponse = (APIProjectPagedResponse) o;
    return Objects.equals(this.succeeded, apIProjectPagedResponse.succeeded) &&
        Objects.equals(this.message, apIProjectPagedResponse.message) &&
        Objects.equals(this.errors, apIProjectPagedResponse.errors) &&
        Objects.equals(this.data, apIProjectPagedResponse.data) &&
        Objects.equals(this.pageNumber, apIProjectPagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, apIProjectPagedResponse.pageSize) &&
        Objects.equals(this.firstPage, apIProjectPagedResponse.firstPage) &&
        Objects.equals(this.lastPage, apIProjectPagedResponse.lastPage) &&
        Objects.equals(this.totalPages, apIProjectPagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, apIProjectPagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, apIProjectPagedResponse.nextPage) &&
        Objects.equals(this.previousPage, apIProjectPagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, apIProjectPagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class APIProjectPagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to APIProjectPagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!APIProjectPagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in APIProjectPagedResponse is not found in the empty JSON string", APIProjectPagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            APIProject.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!APIProjectPagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'APIProjectPagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<APIProjectPagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(APIProjectPagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<APIProjectPagedResponse>() {
           @Override
           public void write(JsonWriter out, APIProjectPagedResponse value) throws IOException {
           ...
           @Override
           public APIProjectPagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             APIProjectPagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of APIProjectPagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of APIProjectPagedResponse
  * @throws IOException if the JSON string is invalid with respect to APIProjectPagedResponse
  */
  public static APIProjectPagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, APIProjectPagedResponse.class);
  }

 /**
  * Convert an instance of APIProjectPagedResponse to an JSON string
  *
  * @return JSON string
  */
