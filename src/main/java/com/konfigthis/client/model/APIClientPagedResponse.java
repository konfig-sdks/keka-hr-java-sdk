...
public class APIClientPagedResponse {
  ...
  private List<ModelAPIClient> data = null;
  ...
  public APIClientPagedResponse() {
  }

  public APIClientPagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public APIClientPagedResponse message(String message) {
  ...
  **/
  ...
  public APIClientPagedResponse errors(List<String> errors) {
  ...
  public APIClientPagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public APIClientPagedResponse data(List<ModelAPIClient> data) {
  ...
  public APIClientPagedResponse addDataItem(ModelAPIClient dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<ModelAPIClient> getData() {
    return data;
  }


  public void setData(List<ModelAPIClient> data) {
  ...
  public APIClientPagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public APIClientPagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public APIClientPagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public APIClientPagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public APIClientPagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public APIClientPagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public APIClientPagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public APIClientPagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the APIClientPagedResponse instance itself
   */
  public APIClientPagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    APIClientPagedResponse apIClientPagedResponse = (APIClientPagedResponse) o;
    return Objects.equals(this.succeeded, apIClientPagedResponse.succeeded) &&
        Objects.equals(this.message, apIClientPagedResponse.message) &&
        Objects.equals(this.errors, apIClientPagedResponse.errors) &&
        Objects.equals(this.data, apIClientPagedResponse.data) &&
        Objects.equals(this.pageNumber, apIClientPagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, apIClientPagedResponse.pageSize) &&
        Objects.equals(this.firstPage, apIClientPagedResponse.firstPage) &&
        Objects.equals(this.lastPage, apIClientPagedResponse.lastPage) &&
        Objects.equals(this.totalPages, apIClientPagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, apIClientPagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, apIClientPagedResponse.nextPage) &&
        Objects.equals(this.previousPage, apIClientPagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, apIClientPagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class APIClientPagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to APIClientPagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!APIClientPagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in APIClientPagedResponse is not found in the empty JSON string", APIClientPagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ModelAPIClient.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!APIClientPagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'APIClientPagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<APIClientPagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(APIClientPagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<APIClientPagedResponse>() {
           @Override
           public void write(JsonWriter out, APIClientPagedResponse value) throws IOException {
           ...
           @Override
           public APIClientPagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             APIClientPagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of APIClientPagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of APIClientPagedResponse
  * @throws IOException if the JSON string is invalid with respect to APIClientPagedResponse
  */
  public static APIClientPagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, APIClientPagedResponse.class);
  }

 /**
  * Convert an instance of APIClientPagedResponse to an JSON string
  *
  * @return JSON string
  */
