...
import com.konfigthis.client.model.ExpenseCategory;
...
public class ExpenseCategoryPagedResponse {
  ...
  private List<ExpenseCategory> data = null;
  ...
  public ExpenseCategoryPagedResponse() {
  }

  public ExpenseCategoryPagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public ExpenseCategoryPagedResponse message(String message) {
  ...
  **/
  ...
  public ExpenseCategoryPagedResponse errors(List<String> errors) {
  ...
  public ExpenseCategoryPagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public ExpenseCategoryPagedResponse data(List<ExpenseCategory> data) {
  ...
  public ExpenseCategoryPagedResponse addDataItem(ExpenseCategory dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public ExpenseCategoryPagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public ExpenseCategoryPagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public ExpenseCategoryPagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public ExpenseCategoryPagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public ExpenseCategoryPagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public ExpenseCategoryPagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public ExpenseCategoryPagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public ExpenseCategoryPagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the ExpenseCategoryPagedResponse instance itself
   */
  public ExpenseCategoryPagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpenseCategoryPagedResponse expenseCategoryPagedResponse = (ExpenseCategoryPagedResponse) o;
    return Objects.equals(this.succeeded, expenseCategoryPagedResponse.succeeded) &&
        Objects.equals(this.message, expenseCategoryPagedResponse.message) &&
        Objects.equals(this.errors, expenseCategoryPagedResponse.errors) &&
        Objects.equals(this.data, expenseCategoryPagedResponse.data) &&
        Objects.equals(this.pageNumber, expenseCategoryPagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, expenseCategoryPagedResponse.pageSize) &&
        Objects.equals(this.firstPage, expenseCategoryPagedResponse.firstPage) &&
        Objects.equals(this.lastPage, expenseCategoryPagedResponse.lastPage) &&
        Objects.equals(this.totalPages, expenseCategoryPagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, expenseCategoryPagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, expenseCategoryPagedResponse.nextPage) &&
        Objects.equals(this.previousPage, expenseCategoryPagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, expenseCategoryPagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExpenseCategoryPagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ExpenseCategoryPagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExpenseCategoryPagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExpenseCategoryPagedResponse is not found in the empty JSON string", ExpenseCategoryPagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ExpenseCategory.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpenseCategoryPagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpenseCategoryPagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpenseCategoryPagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpenseCategoryPagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpenseCategoryPagedResponse>() {
           @Override
           public void write(JsonWriter out, ExpenseCategoryPagedResponse value) throws IOException {
           ...
           @Override
           public ExpenseCategoryPagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ExpenseCategoryPagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ExpenseCategoryPagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ExpenseCategoryPagedResponse
  * @throws IOException if the JSON string is invalid with respect to ExpenseCategoryPagedResponse
  */
  public static ExpenseCategoryPagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExpenseCategoryPagedResponse.class);
  }

 /**
  * Convert an instance of ExpenseCategoryPagedResponse to an JSON string
  *
  * @return JSON string
  */
