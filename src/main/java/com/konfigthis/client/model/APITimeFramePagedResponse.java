...
import com.konfigthis.client.model.APITimeFrame;
...
public class APITimeFramePagedResponse {
  ...
  private List<APITimeFrame> data = null;
  ...
  public APITimeFramePagedResponse() {
  }

  public APITimeFramePagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public APITimeFramePagedResponse message(String message) {
  ...
  **/
  ...
  public APITimeFramePagedResponse errors(List<String> errors) {
  ...
  public APITimeFramePagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public APITimeFramePagedResponse data(List<APITimeFrame> data) {
  ...
  public APITimeFramePagedResponse addDataItem(APITimeFrame dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<APITimeFrame> getData() {
    return data;
  }


  public void setData(List<APITimeFrame> data) {
  ...
  public APITimeFramePagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public APITimeFramePagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public APITimeFramePagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public APITimeFramePagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public APITimeFramePagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public APITimeFramePagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public APITimeFramePagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public APITimeFramePagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the APITimeFramePagedResponse instance itself
   */
  public APITimeFramePagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    APITimeFramePagedResponse apITimeFramePagedResponse = (APITimeFramePagedResponse) o;
    return Objects.equals(this.succeeded, apITimeFramePagedResponse.succeeded) &&
        Objects.equals(this.message, apITimeFramePagedResponse.message) &&
        Objects.equals(this.errors, apITimeFramePagedResponse.errors) &&
        Objects.equals(this.data, apITimeFramePagedResponse.data) &&
        Objects.equals(this.pageNumber, apITimeFramePagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, apITimeFramePagedResponse.pageSize) &&
        Objects.equals(this.firstPage, apITimeFramePagedResponse.firstPage) &&
        Objects.equals(this.lastPage, apITimeFramePagedResponse.lastPage) &&
        Objects.equals(this.totalPages, apITimeFramePagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, apITimeFramePagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, apITimeFramePagedResponse.nextPage) &&
        Objects.equals(this.previousPage, apITimeFramePagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, apITimeFramePagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class APITimeFramePagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to APITimeFramePagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!APITimeFramePagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in APITimeFramePagedResponse is not found in the empty JSON string", APITimeFramePagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            APITimeFrame.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!APITimeFramePagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'APITimeFramePagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<APITimeFramePagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(APITimeFramePagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<APITimeFramePagedResponse>() {
           @Override
           public void write(JsonWriter out, APITimeFramePagedResponse value) throws IOException {
           ...
           @Override
           public APITimeFramePagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             APITimeFramePagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of APITimeFramePagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of APITimeFramePagedResponse
  * @throws IOException if the JSON string is invalid with respect to APITimeFramePagedResponse
  */
  public static APITimeFramePagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, APITimeFramePagedResponse.class);
  }

 /**
  * Convert an instance of APITimeFramePagedResponse to an JSON string
  *
  * @return JSON string
  */
