...
public class BatchPagedResponse {
  ...
  public BatchPagedResponse succeeded(Boolean succeeded) {
  ...
  **/
  ...
  public BatchPagedResponse message(String message) {
  ...
  **/
  ...
  public BatchPagedResponse errors(List<String> errors) {
  ...
  public BatchPagedResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public BatchPagedResponse data(List<Batch> data) {
  ...
  public BatchPagedResponse addDataItem(Batch dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public BatchPagedResponse pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public BatchPagedResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public BatchPagedResponse firstPage(URI firstPage) {
  ...
  **/
  ...
  public BatchPagedResponse lastPage(URI lastPage) {
  ...
  **/
  ...
  public BatchPagedResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public BatchPagedResponse totalRecords(Integer totalRecords) {
  ...
  **/
  ...
  public BatchPagedResponse nextPage(URI nextPage) {
  ...
  **/
  ...
  public BatchPagedResponse previousPage(URI previousPage) {
  ...
  **/
   ...
   * @return the BatchPagedResponse instance itself
   */
  public BatchPagedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BatchPagedResponse batchPagedResponse = (BatchPagedResponse) o;
    return Objects.equals(this.succeeded, batchPagedResponse.succeeded) &&
        Objects.equals(this.message, batchPagedResponse.message) &&
        Objects.equals(this.errors, batchPagedResponse.errors) &&
        Objects.equals(this.data, batchPagedResponse.data) &&
        Objects.equals(this.pageNumber, batchPagedResponse.pageNumber) &&
        Objects.equals(this.pageSize, batchPagedResponse.pageSize) &&
        Objects.equals(this.firstPage, batchPagedResponse.firstPage) &&
        Objects.equals(this.lastPage, batchPagedResponse.lastPage) &&
        Objects.equals(this.totalPages, batchPagedResponse.totalPages) &&
        Objects.equals(this.totalRecords, batchPagedResponse.totalRecords) &&
        Objects.equals(this.nextPage, batchPagedResponse.nextPage) &&
        Objects.equals(this.previousPage, batchPagedResponse.previousPage)&&
        Objects.equals(this.additionalProperties, batchPagedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchPagedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BatchPagedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BatchPagedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchPagedResponse is not found in the empty JSON string", BatchPagedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Batch.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchPagedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchPagedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchPagedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchPagedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchPagedResponse>() {
           @Override
           public void write(JsonWriter out, BatchPagedResponse value) throws IOException {
           ...
           @Override
           public BatchPagedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BatchPagedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BatchPagedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BatchPagedResponse
  * @throws IOException if the JSON string is invalid with respect to BatchPagedResponse
  */
  public static BatchPagedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchPagedResponse.class);
  }

 /**
  * Convert an instance of BatchPagedResponse to an JSON string
  *
  * @return JSON string
  */
