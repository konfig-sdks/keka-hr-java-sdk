...
public class TimesheetEntriesApiTest {
    ...
    private static TimesheetEntriesApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new TimesheetEntriesApi(apiClient);
    }
     ...
     */
    @Test
    public void getBetweenDatesTest() throws ApiException {
        ...
        APITimesheetEntryPagedResponse response = api.getBetweenDates()
                .from(from)
                .to(to)
