...
|------------- | ------------- | -------------|
| [**getList**](BadgeApi.md#getList) | **GET** /pms/badges | Gets badge list. |


<a name="getList"></a>
# **getList**
> APIBadgePagedResponse getList().badgeIds(badgeIds).pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String badgeIds = "badgeIds_example"; // Comma separated list of one or more Badge ids you'd like to filter on.
    ...
    try {
      APIBadgePagedResponse result = client
              .badge
              .getList()
              .badgeIds(badgeIds)
      ...
      System.err.println("Exception when calling BadgeApi#getList");
    ...
    try {
      ApiResponse<APIBadgePagedResponse> response = client
              .badge
              .getList()
              .badgeIds(badgeIds)
              .pageNumber(pageNumber)
...
|------------- | ------------- | ------------- | -------------|
| **badgeIds** | **String**| Comma separated list of one or more Badge ids you&#39;d like to filter on. | [optional] |
...
[**APIBadgePagedResponse**](APIBadgePagedResponse.md)
