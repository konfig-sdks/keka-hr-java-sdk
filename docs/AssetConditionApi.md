...
|------------- | ------------- | -------------|
| [**getAll**](AssetConditionApi.md#getAll) | **GET** /assets/conditions | Get all Asset Conditions |


<a name="getAll"></a>
# **getAll**
> ApiLookupPagedResponse getAll().assetConditionIds(assetConditionIds).lastModified(lastModified).pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String assetConditionIds = "assetConditionIds_example"; // The asset condition ids.
    ...
    try {
      ...
      System.err.println("Exception when calling AssetConditionApi#getAll");
...
|------------- | ------------- | ------------- | -------------|
| **assetConditionIds** | **String**| The asset condition ids. | [optional] |
