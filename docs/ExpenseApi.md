...
|------------- | ------------- | -------------|
| [**getAllClaims**](ExpenseApi.md#getAllClaims) | **GET** /expense/claims | Get all Expense Claims |


<a name="getAllClaims"></a>
# **getAllClaims**
> ExpenseClaimPagedResponse getAllClaims().pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ExpenseClaimPagedResponse result = client
              .expense
              .getAllClaims()
      ...
      System.err.println("Exception when calling ExpenseApi#getAllClaims");
    ...
    try {
      ApiResponse<ExpenseClaimPagedResponse> response = client
              .expense
              .getAllClaims()
              .pageNumber(pageNumber)
              .pageSize(pageSize)
...
[**ExpenseClaimPagedResponse**](ExpenseClaimPagedResponse.md)
