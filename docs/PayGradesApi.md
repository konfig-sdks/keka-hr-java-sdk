...
|------------- | ------------- | -------------|
| [**getAll**](PayGradesApi.md#getAll) | **GET** /payroll/paygrades | Get all Pay Grades |


<a name="getAll"></a>
# **getAll**
> ApiLookupPagedResponse getAll().payGradeIds(payGradeIds).pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String payGradeIds = "payGradeIds_example"; // The paygrade ids.
...
|------------- | ------------- | ------------- | -------------|
| **payGradeIds** | **String**| The paygrade ids. | [optional] |
