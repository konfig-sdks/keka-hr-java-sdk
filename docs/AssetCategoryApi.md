...
|------------- | ------------- | -------------|
| [**getAll**](AssetCategoryApi.md#getAll) | **GET** /assets/categories | Get all Asset Categories |


<a name="getAll"></a>
# **getAll**
> ApiLookupPagedResponse getAll().assetCategoryIds(assetCategoryIds).lastModified(lastModified).pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String assetCategoryIds = "assetCategoryIds_example"; // The asset category ids.
    ...
    try {
      ...
      System.err.println("Exception when calling AssetCategoryApi#getAll");
...
|------------- | ------------- | ------------- | -------------|
| **assetCategoryIds** | **String**| The asset category ids. | [optional] |
