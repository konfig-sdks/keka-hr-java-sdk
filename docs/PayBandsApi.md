...
|------------- | ------------- | -------------|
| [**getAll**](PayBandsApi.md#getAll) | **GET** /payroll/paybands | Get all Pay Bands |


<a name="getAll"></a>
# **getAll**
> ApiLookupPagedResponse getAll().payBandIds(payBandIds).pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String payBandIds = "payBandIds_example"; // The payband ids.
    ...
    try {
      ...
      System.err.println("Exception when calling PayBandsApi#getAll");
...
|------------- | ------------- | ------------- | -------------|
| **payBandIds** | **String**| The payband ids. | [optional] |
