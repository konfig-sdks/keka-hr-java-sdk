...
|------------- | ------------- | -------------|
| [**getAll**](TimeFramesApi.md#getAll) | **GET** /pms/timeframes | Gets time frame list. |


<a name="getAll"></a>
# **getAll**
> APITimeFramePagedResponse getAll().timeFrameIds(timeFrameIds).pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      APITimeFramePagedResponse result = client
              .timeFrames
              .getAll()
      ...
      System.err.println("Exception when calling TimeFramesApi#getAll");
    ...
    try {
      ApiResponse<APITimeFramePagedResponse> response = client
              .timeFrames
              .getAll()
              .timeFrameIds(timeFrameIds)
              .pageNumber(pageNumber)
...
[**APITimeFramePagedResponse**](APITimeFramePagedResponse.md)
