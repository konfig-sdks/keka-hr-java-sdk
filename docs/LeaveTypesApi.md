...
|------------- | ------------- | -------------|
| [**listAll**](LeaveTypesApi.md#listAll) | **GET** /time/leavetypes | Get all Leave Types |


<a name="listAll"></a>
# **listAll**
> LeaveTypePagedResponse listAll().leaveTypeIds(leaveTypeIds).pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String leaveTypeIds = "leaveTypeIds_example"; // Comma separated list of one or more leave type identifiers you'd like to filter on..
    ...
    try {
      LeaveTypePagedResponse result = client
              .leaveTypes
              .listAll()
      ...
      System.err.println("Exception when calling LeaveTypesApi#listAll");
    ...
    try {
      ApiResponse<LeaveTypePagedResponse> response = client
              .leaveTypes
              .listAll()
              .leaveTypeIds(leaveTypeIds)
              .pageNumber(pageNumber)
...
|------------- | ------------- | ------------- | -------------|
| **leaveTypeIds** | **String**| Comma separated list of one or more leave type identifiers you&#39;d like to filter on.. | [optional] |
...
[**LeaveTypePagedResponse**](LeaveTypePagedResponse.md)
