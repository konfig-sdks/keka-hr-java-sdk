...
|------------- | ------------- | -------------|
| [**getAll**](JobTitleApi.md#getAll) | **GET** /hris/jobtitles | Get all jobtitles |


<a name="getAll"></a>
# **getAll**
> JobTitlePagedResponse getAll().lastModified(lastModified).pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      JobTitlePagedResponse result = client
              .jobTitle
              .getAll()
      ...
      System.err.println("Exception when calling JobTitleApi#getAll");
    ...
    try {
      ApiResponse<JobTitlePagedResponse> response = client
              .jobTitle
              .getAll()
              .lastModified(lastModified)
              .pageNumber(pageNumber)
...
[**JobTitlePagedResponse**](JobTitlePagedResponse.md)
