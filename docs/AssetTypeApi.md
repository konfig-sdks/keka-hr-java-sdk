...
|------------- | ------------- | -------------|
| [**getAll**](AssetTypeApi.md#getAll) | **GET** /assets/types | Get all Asset Types |


<a name="getAll"></a>
# **getAll**
> ApiLookupPagedResponse getAll().assetTypeIds(assetTypeIds).lastModified(lastModified).pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String assetTypeIds = "assetTypeIds_example"; // The asset type ids.
    ...
    try {
      ...
      System.err.println("Exception when calling AssetTypeApi#getAll");
...
|------------- | ------------- | ------------- | -------------|
| **assetTypeIds** | **String**| The asset type ids. | [optional] |
