...
|------------- | ------------- | -------------|
| [**getAll**](LocationsApi.md#getAll) | **GET** /hris/locations | Get all Locations |


<a name="getAll"></a>
# **getAll**
> LocationPagedResponse getAll().lastModified(lastModified).pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      LocationPagedResponse result = client
              .locations
              .getAll()
      ...
      System.err.println("Exception when calling LocationsApi#getAll");
    ...
    try {
      ApiResponse<LocationPagedResponse> response = client
              .locations
              .getAll()
              .lastModified(lastModified)
              .pageNumber(pageNumber)
...
[**LocationPagedResponse**](LocationPagedResponse.md)
