...
|------------- | ------------- | -------------|
| [**getAll**](CurrencyApi.md#getAll) | **GET** /hris/currencies | Get all currencies |


<a name="getAll"></a>
# **getAll**
> CurrencyPagedResponse getAll().pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CurrencyPagedResponse result = client
              .currency
              .getAll()
      ...
      System.err.println("Exception when calling CurrencyApi#getAll");
    ...
    try {
      ApiResponse<CurrencyPagedResponse> response = client
              .currency
              .getAll()
              .pageNumber(pageNumber)
              .pageSize(pageSize)
...
[**CurrencyPagedResponse**](CurrencyPagedResponse.md)
