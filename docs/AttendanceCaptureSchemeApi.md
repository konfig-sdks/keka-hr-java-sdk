...
|------------- | ------------- | -------------|
| [**getAll**](AttendanceCaptureSchemeApi.md#getAll) | **GET** /time/capturescheme | Get all captureschemes |


<a name="getAll"></a>
# **getAll**
> ApiLookupPagedResponse getAll().captureschemeIds(captureschemeIds).pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String captureschemeIds = "captureschemeIds_example"; // The capturescheme ids.
    ...
    try {
      ApiLookupPagedResponse result = client
              ...
              .getAll()
              .captureschemeIds(captureschemeIds)
      ...
      System.err.println("Exception when calling AttendanceCaptureSchemeApi#getAll");
...
|------------- | ------------- | ------------- | -------------|
| **captureschemeIds** | **String**| The capturescheme ids. | [optional] |
