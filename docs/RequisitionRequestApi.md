...
|------------- | ------------- | -------------|
| [**getAll**](RequisitionRequestApi.md#getAll) | **GET** /requisition/requests | Get all Requisition Requests |


<a name="getAll"></a>
# **getAll**
> RequisitionRequestPagedResponse getAll().requisitionRequestIds(requisitionRequestIds).status(status).lastModified(lastModified).pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String requisitionRequestIds = "requisitionRequestIds_example"; // The requisition request ids.
    String status = "status_example"; // The status.
    ...
    try {
      RequisitionRequestPagedResponse result = client
              .requisitionRequest
              .getAll()
      ...
      System.err.println("Exception when calling RequisitionRequestApi#getAll");
    ...
    try {
      ApiResponse<RequisitionRequestPagedResponse> response = client
              .requisitionRequest
              .getAll()
              .requisitionRequestIds(requisitionRequestIds)
              .status(status)
...
|------------- | ------------- | ------------- | -------------|
| **requisitionRequestIds** | **String**| The requisition request ids. | [optional] |
...
[**RequisitionRequestPagedResponse**](RequisitionRequestPagedResponse.md)
