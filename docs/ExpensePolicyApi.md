...
|------------- | ------------- | -------------|
| [**listAllExpensePolicies**](ExpensePolicyApi.md#listAllExpensePolicies) | **GET** /expensepolicies | Get all expensepolicies |


<a name="listAllExpensePolicies"></a>
# **listAllExpensePolicies**
> ApiLookupPagedResponse listAllExpensePolicies().expensepolicyIds(expensepolicyIds).pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String expensepolicyIds = "expensepolicyIds_example"; // The expensepolicy ids.
    ...
    try {
      ...
      System.err.println("Exception when calling ExpensePolicyApi#listAllExpensePolicies");
...
|------------- | ------------- | ------------- | -------------|
| **expensepolicyIds** | **String**| The expensepolicy ids. | [optional] |
