...
|------------- | ------------- | -------------|
| [**createPhaseIdentifier**](ProjectPhasesApi.md#createPhaseIdentifier) | **POST** /psa/projects/{projectId}/phases | Create a Project Phase |
| [**getAll**](ProjectPhasesApi.md#getAll) | **GET** /psa/projects/{projectId}/phases | Get project phases. |


<a name="createPhaseIdentifier"></a>
# **createPhaseIdentifier**
> StringResponse createPhaseIdentifier(projectId).phaseName(phaseName).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String phaseName = "phaseName_example"; // Name of the phase.
    try {
      StringResponse result = client
              .projectPhases
              .createPhaseIdentifier(projectId)
              .phaseName(phaseName)
              .execute();
      ...
      System.err.println("Exception when calling ProjectPhasesApi#createPhaseIdentifier");
...
| **phaseName** | **String**| Name of the phase. | [optional] |
...
<a name="getAll"></a>
# **getAll**
> ProjectPhasePagedResponse getAll(projectId).lastModified(lastModified).pageNumber(pageNumber).pageSize(pageSize).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ProjectPhasePagedResponse result = client
              .projectPhases
              .getAll(projectId)
      ...
      System.err.println("Exception when calling ProjectPhasesApi#getAll");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
    ...
    // Use .executeWithHttpInfo() to retrieve HTTP Status Code, Headers and Request
    try {
      ApiResponse<ProjectPhasePagedResponse> response = client
              .projectPhases
              .getAll(projectId)
              .lastModified(lastModified)
              .pageNumber(pageNumber)
...
[**ProjectPhasePagedResponse**](ProjectPhasePagedResponse.md)
